            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="pt-4 flex flex-col sm:flex-row gap-4">
                    <button
                        ...
                        className="w-full sm:w-1/3 flex justify-center items-center py-3.5 text-sm font-bold text-slate-700 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl transition-all"
                    >
                        Cancel
                    </button>
                    <button
                        disabled={loading}
                        type="submit"
                        className="w-full sm:w-2/3 flex justify-center items-center gap-2 px-6 py-3.5 text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 rounded-xl transition-all shadow-md shadow-indigo-600/20"
                    >
