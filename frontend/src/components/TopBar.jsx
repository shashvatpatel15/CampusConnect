...
import { LayoutDashboard, CalendarDays, Users, LogOut, LogIn, PieChart, Menu, X, Plus, ShieldCheck } from 'lucide-react';
...
export default function TopBar() {
    ...
    const navLinks = [
        ...
        { to: '/admin', label: 'Admin', icon: ShieldCheck, show: currentUser?.role === 'admin' },
    ];
        ...
        <header className="top-bar flex items-center justify-between px-4 sm:px-6 py-3.5 border-b border-slate-200 backdrop-blur-xl bg-white/80 sticky top-0 z-40">
            ...
            >
                ...
                <div className="brand-text flex flex-col">
                    ...
                    <span className="brand-subtitle text-[10px] text-slate-500 font-medium tracking-wide uppercase hidden sm:block">
                        Elevate Your Skills
                    </span>
                </div>
            </Link>
